...
const Featuresection = () => {
  ...
  return (
    <section className="px-4 py-22 bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Comprehensive Legal Solutions</h2>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <div
                ...
                key={index}
                className="feature-card group hover:shadow-2xl transition-all duration-500 cursor-pointer border-2 border-slate-200 hover:border-amber-500/30 bg-white rounded-2xl p-8"
              >
                <div
                  ref={(el) => { iconRef.current[index] = el! }}
                  className="bg-gradient-to-br from-slate-900 to-slate-800 h-16 w-16 flex items-center justify-center rounded-xl mb-6 shadow-lg group-hover:shadow-xl transition-shadow mt-3"
                >
                ...
                <div className='mt-6'>
                  <div className='flex items-center text-slate-900 font-medium group-hover:translate-x-2 transition-transform group-hover:text-amber-600'>
                    Learn More
