            ...
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    {appointment.appointmentStatus === 'scheduled' && (
                        <>
                            <button
                                onClick={() => onJoinCall(appointment.callRoomId)}
                                className="flex-1 md:flex-none inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg transition-colors font-medium text-sm bg-slate-900 text-white hover:bg-slate-800"
                            >
                                <Video size={16} />
                                Join Call
                            </button>
